...
| 5. Site Content | **Blocked** — needs the database | Read Q8 first — the key names are not the PRD's. Ruling recorded: seed `privacy_copy`/`terms_copy` in a migration; the screen only updates |
